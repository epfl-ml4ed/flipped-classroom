...
from helper.dataset.data_preparation import *
...
def getStudentCondition(flipped=True, id_anon=False):
    CONDITION_MAPPING_PATH = '../data/lin_alg_moodle/volunteer_flipped.csv'
...
def getExamAnswers(year=None):
    ...
    if year == None:
        ...
        raise ValueError("Year argument not recognized: {year}")
