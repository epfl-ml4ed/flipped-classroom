...
def train_individual(timeframes, course_ids, predictors, base_settings):
...
def train_ensemble(timeframes, course_ids, predictors, base_settings):
    for timeframe in timeframes:
        for course_id in course_ids:
            feature_sets = [fs for fs in os.listdir('../data/result/edm21/feature') if timeframe in fs and course_id in fs]
...
if __name__ == "__main__":
    ...
    course_ids = ['epfl-algebrelineaire']
    ...
    train_individual(timeframes, course_ids, predictors, base_settings)

    train_ensemble(timeframes, course_ids, predictors, base_settings)