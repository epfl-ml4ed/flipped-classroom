...
class Features(unittest.TestCase):
    ...
    def test_PDH(self):
        ...
        self.assertAlmostEqual(PDH(Lw, T), np.log2(24) * Lw, 2) #2 decimals accuracy

    # PWD bounded in [0, log(7) * L_w]
    def test_PWD(self):  
        # Particular sid
        sid, T, Lw = getStudentTimeStamps(self.video_df, 9749)
        self.assertAlmostEqual(PWD(Lw, T), 7.51, 2) #2 decimals accuracy
        ...
        self.assertAlmostEqual(PWD(Lw, T), np.log2(7) * Lw, 2) #2 decimals accuracy
